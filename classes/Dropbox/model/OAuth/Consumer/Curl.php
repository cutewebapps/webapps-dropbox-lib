...
class Dropbox_OAuth_Consumer_Curl extends Dropbox_OAuth_Consumer_ConsumerAbstract
{
	 ...
	 * @param string $key
	 * @param string $secret
	 * @param Dropbox_OAuth_Storage_StorageInterface $storage
	 * @param string $callback
	 */
	public function __construct($key, $secret, Dropbox_OAuth_Storage_StorageInterface $storage, $callback = null)
	{
